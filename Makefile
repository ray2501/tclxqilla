...
PKG_SOURCES	=  xqillaStubInit.c tclxqilla.c
PKG_OBJECTS	=  xqillaStubInit.o tclxqilla.o
...
PKG_LIB_FILE	= libxqilla0.1.3.so
PKG_LIB_FILE8	= libxqilla0.1.3.so
PKG_LIB_FILE9	= libtcl9xqilla0.1.3.so
PKG_STUB_LIB_FILE = libxqillastub0.1.3.a
...
top_builddir	= /home/danilo/Public/tclxqilla
